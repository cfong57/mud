...
void extra_create()
{
  set_short( "Sitting at the corner table, Bastion's dining room" );
  set_long(wrap("You are sitting at the corner table in the Bastion's dining "+
  "room. Although this table is more humble, you somehow feel at ease here, "+
  "as if all the cares in the world were washing away. You remember that "+
