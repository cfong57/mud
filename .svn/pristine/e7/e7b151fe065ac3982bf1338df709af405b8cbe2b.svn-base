...
void extra_create()
{
  ...
  add_monster("/u/a/allanon/area/caverns_of_slime/mon/robber3.c");   
  ...
  set_exits(
  ([
    "east" : "/u/a/allanon/area/caverns_of_slime/rooms/pool3.c",
    "west" : "/u/a/allanon/area/caverns_of_slime/rooms/intersection.c"]));
}