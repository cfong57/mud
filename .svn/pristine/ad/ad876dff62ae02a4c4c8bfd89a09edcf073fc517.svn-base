...
void extra_create()
{
  ...
  "large spiderweb.\n"));
  set_item_desc(([
  ({"crates", "barrels", "sacks", "containers"}) : "Most of the "+
  ...
  ({"sealed containers"}) : "Some of the containers have been sealed shut "+
  ...
  ({"hooks", "bones", "ceiling", "floor"}) : "A number of iron hooks are "+
